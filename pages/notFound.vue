        ...
        <div class="container notFoundPage">
           <div class="row image">
            <div class="col-12 col-xl-5 col-lg-5 col-md-4 text">
             <h3>{{ $t("Didn't Find Your Car?") }}</h3>
             <h3>{{ $t('We Can Provide It For You.') }}</h3>
             <p>
                {{ $t('fill the info') }}
              </p>
            </div>
            ...
            <form action="" class="mt-5" @submit.prevent>
              ...
              <span class="errorMessage text-danger fw-bold "  v-if="nameError">{{ nameError }}</span>
               ...
               <div class="col-12 col-xl-6 col-lg-6 col-md-5 my-2 inp">
                 ...
                 <input type="text"  v-model="mainObj.phone" placeholder="0xxxxxxxx">
  ...
  let result = fetch(`${url}/unavailable-car`, {
    ...
    .then((json) => {
      ...
      spinner.value = false;
         ...
         carNameError.value = json.errors.name  == undefined ? null : json.errors.car_name[0];        
