       ...
       <div class="container career">
          ...
          <div class="row gap-2 justify-content-center">
           <div class="col-12 col-xl-4 col-lg-4 col-md-4    d-flex flex-column gap-3">
             <div class="inpsearch d-flex align-items-center justify-content-between">
              ...
              <div class="jobs d-flex flex-column gap-3">
                  <div v-for="job in allJobs" @click="mainid = job.id" class="job d-flex align-items-center justify-content-between" :class="{'active': job.id == mainid}">
                  <div class="det">
                   <h6>{{ job.title }}</h6>
           ...
           <div v-for="job in allJobs">
                <form v-if="mainid == job.id" action="" @submit.prevent>
...
const sendjob = async () => {
   ...
   spinner.value = true;
  const result = await fetch(`${url}/careers/${mainid.value}/apply`, {
    method: 'POST',
    headers: {
