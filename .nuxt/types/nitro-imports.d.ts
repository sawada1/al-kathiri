declare global {
  const __buildAssetsURL: typeof import('F:/github/AlKathiri-Frontend/node_modules/nuxt/dist/core/runtime/nitro/paths')['buildAssetsURL']
  const __publicAssetsURL: typeof import('F:/github/AlKathiri-Frontend/node_modules/nuxt/dist/core/runtime/nitro/paths')['publicAssetsURL']
  ...
  const cachedEventHandler: typeof import('F:/github/AlKathiri-Frontend/node_modules/nitropack/dist/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('F:/github/AlKathiri-Frontend/node_modules/nitropack/dist/runtime')['cachedFunction']
  ...
  const defineAppConfig: typeof import('F:/github/AlKathiri-Frontend/node_modules/nuxt/dist/core/runtime/nitro/config')['defineAppConfig']
  const defineCachedEventHandler: typeof import('F:/github/AlKathiri-Frontend/node_modules/nitropack/dist/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('F:/github/AlKathiri-Frontend/node_modules/nitropack/dist/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('h3')['defineLazyEventHandler']
  const defineNitroPlugin: typeof import('F:/github/AlKathiri-Frontend/node_modules/nitropack/dist/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('F:/github/AlKathiri-Frontend/node_modules/nitropack/dist/runtime')['defineRenderHandler']
  ...
  const getRouteRules: typeof import('F:/github/AlKathiri-Frontend/node_modules/nitropack/dist/runtime')['getRouteRules']
  ...
  const nitroPlugin: typeof import('F:/github/AlKathiri-Frontend/node_modules/nitropack/dist/runtime')['nitroPlugin']
  ...
  const useAppConfig: typeof import('F:/github/AlKathiri-Frontend/node_modules/nitropack/dist/runtime')['useAppConfig']
  const useBase: typeof import('h3')['useBase']
  const useNitroApp: typeof import('F:/github/AlKathiri-Frontend/node_modules/nitropack/dist/runtime')['useNitroApp']
  const useRuntimeConfig: typeof import('F:/github/AlKathiri-Frontend/node_modules/nitropack/dist/runtime')['useRuntimeConfig']
  const useSession: typeof import('h3')['useSession']
  const useStorage: typeof import('F:/github/AlKathiri-Frontend/node_modules/nitropack/dist/runtime')['useStorage']
