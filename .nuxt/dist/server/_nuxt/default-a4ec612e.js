...
const _imports_3 = "" + __buildAssetsURL("whatsapp-logo.58b78e40.png");
...
const _imports_5 = "" + __buildAssetsURL("footer2.6db134cc.png");
const _imports_6 = "" + __buildAssetsURL("logo-footer.6afad4af.svg");
const _sfc_main = {
  __name: "default",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<p class="mt-2 fw-bold">${ssrInterpolate(_ctx.$t("For Maintenance"))}</p></div></div></div><div class="text"><span>© ${ssrInterpolate(_ctx.$t("AL KATHIRI MOTORS"))}, ${ssrInterpolate(_ctx.$t("All Rights Reserved"))}</span><p><span>${ssrInterpolate(_ctx.$t("Developed By"))}</span><a target="_blank" href="https://www.webstdy.com"><img${ssrRenderAttr("src", _imports_6)} alt="webstdy"></a></p></div><i class="fa-solid fa-arrow-up" id="arrow-up"></i></div></div>`);
    };
  }
};
...
//# sourceMappingURL=default-a4ec612e.js.map
