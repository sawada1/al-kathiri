...
import { _ as __nuxt_component_1, a as __nuxt_component_2 } from "./privacyModal-ded9970f.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<p class="mt-2">${ssrInterpolate(_ctx.$t("For Maintenance"))}</p></div></div></div><div class="text"><span>© ${ssrInterpolate(_ctx.$t("AL KATHIRI MOTORS"))}, ${ssrInterpolate(_ctx.$t("All Rights Reserved"))}</span><p><span>${ssrInterpolate(_ctx.$t("Developed By"))}</span><a target="_blank" href="https://www.webstdy.com"><img${ssrRenderAttr("src", _imports_5)} alt="webstdy"></a></p></div><i class="fa-solid fa-arrow-up" id="arrow-up"></i></div></div>`);
    };
  }
};
...
//# sourceMappingURL=default-fc09b751.js.map
