...
/* empty css                */import { ssrRenderAttrs, ssrInterpolate, ssrRenderList, ssrRenderStyle, ssrRenderClass, ssrRenderAttr, ssrRenderComponent } from "vue/server-renderer";
import "js-cookie";
import "ofetch";
...
const _imports_1 = "" + __buildAssetsURL("icon1.154ded30.svg");
const _imports_2 = "" + __buildAssetsURL("icon5.0bf3140c.svg");
const _imports_3 = "" + __buildAssetsURL("noun-speed-3341122.92f20c0a.svg");
const _imports_4 = "" + __buildAssetsURL("noun-transmission-1325127.4e95cda3.svg");
const _imports_5 = "" + __buildAssetsURL("icon3.ad85d6c4.svg");
const _imports_6 = "" + __buildAssetsURL("icon6.215697dd.svg");
const _imports_7 = "" + __buildAssetsURL("icon7.0af21f39.svg");
const _imports_8 = "" + __buildAssetsURL("icon8.76fe68bf.svg");
const _sfc_main = {
  async setup() {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="settings my-5"><div class="container"><div class="row align-items-center justify-content-center"><div class="col-12 col-xl-7 col-lg-7 col-md-6 theSetting"><div class="row gap-2 text-center align-items-center justify-content-center p-3"><div class="col-5 col-xl-2 col-lg-2 col-md-3 d-flex flex-column align-items-center p-2" style="${ssrRenderStyle({ "white-space": "nowrap" })}"><img${ssrRenderAttr("src", _imports_1)} alt=""><span>${ssrInterpolate(_ctx.$t("Model Year"))}</span><p class="fw-bold">${ssrInterpolate($setup.mainCar.year)}</p></div><div class="col-5 col-xl-2 col-lg-2 col-md-3 d-flex flex-column align-items-center p-2" style="${ssrRenderStyle({ "white-space": "nowrap" })}"><img${ssrRenderAttr("src", _imports_2)} alt=""><span>${ssrInterpolate(_ctx.$t("Engine"))}</span><p class="fw-bold">${ssrInterpolate($setup.mainCar.fuel_consumption)} liter</p></div><div class="col-5 col-xl-2 col-lg-2 col-md-3 d-flex flex-column align-items-center p-2"><img${ssrRenderAttr("src", _imports_3)} alt=""><span>${ssrInterpolate(_ctx.$t("Kilometers"))}</span><p class="fw-bold">${ssrInterpolate($setup.mainCar.maximum_force)}</p></div><div class="col-5 col-xl-2 col-lg-2 col-md-3 d-flex flex-column align-items-center p-2"><img${ssrRenderAttr("src", _imports_4)} alt=""><span>${ssrInterpolate(_ctx.$t("Transmission"))}</span><p class="fw-bold">${ssrInterpolate($setup.mainCar.motion_vector)}</p></div><div class="col-5 col-xl-2 col-lg-2 col-md-3 d-flex flex-column align-items-center p-2"><img${ssrRenderAttr("src", _imports_5)} alt=""><span>${ssrInterpolate(_ctx.$t("Number Of Doors"))}</span><p class="fw-bold">${ssrInterpolate($setup.mainCar.seats_number)}</p></div><div class="col-5 col-xl-2 col-lg-2 col-md-3 d-flex flex-column align-items-center p-2"><img${ssrRenderAttr("src", _imports_6)} alt=""><span>${ssrInterpolate(_ctx.$t("Seats"))}</span><p class="fw-bold">${ssrInterpolate($setup.mainCar.upholstered_seats)}</p></div><div class="col-5 col-xl-2 col-lg-2 col-md-3 d-flex flex-column align-items-center p-2"><img${ssrRenderAttr("src", _imports_7)} alt=""><span>${ssrInterpolate(_ctx.$t("Transmission"))}</span><p class="fw-bold">${ssrInterpolate($setup.mainCar.traction_type)}</p></div><div class="col-5 col-xl-2 col-lg-2 col-md-3 d-flex flex-column align-items-center p-2"><img${ssrRenderAttr("src", _imports_8)} alt=""><span>${ssrInterpolate(_ctx.$t("Fuel Type "))}</span><p class="fw-bold">${ssrInterpolate($setup.mainCar.engine_type)}</p></div></div></div><div id="nameOfcar" class="${ssrRenderClass([{ "active": $setup.checkNameCarScroll }, "col-12 nameOfcar col-xl-5 col-lg-5 col-md-6 d-flex flex-column gap-3"])}"><div class="carName"><div class="block"><h3 class="fw-bolder">${ssrInterpolate($setup.mainCar.name)}</h3><div class="colors d-flex align-items-center justify-content-between"><p class="available">colors available</p><div class="theColors"><!--[-->`);
  ssrRenderList($setup.apiColors, (color, index2) => {
    _push(`<span style="${ssrRenderStyle({ "background-color": color.hex_code })}" class="${ssrRenderClass({ "active": $setup.colorCar == index2 + 1 })}"></span>`);
  });
  _push(`<!--]--></div><!--[-->`);
...
//# sourceMappingURL=index-49d3f42e.js.map
