...
const styles = {
  "pages/brandcar/index.vue": () => import('./index-styles.76bbe7dc.mjs').then(interopDefault),
  "pages/car/index.vue": () => import('./index-styles.76bbe7dc.mjs').then(interopDefault),
  "pages/index.vue": () => import('./index-styles.76bbe7dc.mjs').then(interopDefault),
