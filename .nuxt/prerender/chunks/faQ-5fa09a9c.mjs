...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div style="${ssrRenderStyle({ "width": "90%", "margin": "20px auto", "margin-top": "150px" })}"><div class="row theFaq gap-4"><div class="col-12 col-xl-3 col-lg-3 col-md-4"><h3${ssrRenderAttr("data-faq", _ctx.$t("FIND YOUR ANSWER"))}>${ssrInterpolate(_ctx.$t("FREQUENTLY ASK QUESTION"))}</h3></div><div class="col-12 col-xl-8 col-lg-8 col-md-7 d-flex flex-column gap-4" style="${ssrRenderStyle({ "min-height": "65vh" })}"><div class="accordion d-flex flex-column gap-3" id="accordionExample"><!--[-->`);
...
//# sourceMappingURL=faQ-5fa09a9c.mjs.map
