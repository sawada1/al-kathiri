...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="container thelatestcar" style="${ssrRenderStyle({ "margin-top": "150px" })}"><div class="thebox"><img class="bigpic"${ssrRenderAttr("src", unref(theproduct).cover_image)}${ssrRenderAttr("alt", unref(theproduct).title)}><div class="title w-100"><h5>${ssrInterpolate(unref(theproduct).title)}</h5><div class="icons"><div class="icon"><img${ssrRenderAttr("src", _imports_0)} alt=""><span>${ssrInterpolate(_ctx.$t("tag name"))}</span></div><div class="icon"><img${ssrRenderAttr("src", _imports_1)} alt=""><span>${ssrInterpolate(unref(theproduct).created_at)}</span></div></div></div>`);
...
//# sourceMappingURL=new-aa8571b8.mjs.map
