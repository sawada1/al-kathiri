...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderComponent, ssrRenderStyle, ssrRenderClass } from 'file://F:/github/AlKathiri-Frontend/node_modules/vue/server-renderer/index.mjs';
import { _ as _imports_1, a as _imports_6, b as _imports_7, c as _imports_8 } from './box3-54fbe1e7.mjs';
...
const _imports_0 = "" + buildAssetsURL("landing2.1afd98b9.png");
const _imports_2 = "" + buildAssetsURL("group1.e89f0768.png");
const _imports_3 = "" + buildAssetsURL("group2.18aae9d5.png");
const _imports_4 = "" + buildAssetsURL("group4.1a6ecf44.png");
const _imports_5 = "" + buildAssetsURL("about.c55be374.png");
const _sfc_main = {
  components: {
    Swiper,
    SwiperSlide
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div></div></div></div></div></div><div class="why-choose"><div class="head"><h3 class="fw-bolder"${ssrRenderAttr("data-why", _ctx.$t("AL KATHIRI MOTORS"))}>${ssrInterpolate(_ctx.$t("why choose us"))}</h3></div><div class="main mb-5 position-relative"><div class="boxes row d-flex justify-content-center gap-5"><div class="box col-xl-3 col-lg-3 col-md-5 col-sm-12"><img${ssrRenderAttr("src", _imports_6)} loading="lazy" alt="why-choose"><div class="text">`);
  _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
  _push(`</div>`);
...
//# sourceMappingURL=index-a8709bcc.mjs.map
