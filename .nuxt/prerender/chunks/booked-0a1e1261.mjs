...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="container bookPart d-flex flex-column gap-3 align-items-center justify-content-center" style="${ssrRenderStyle({ "margin-top": "150px" })}"><img${ssrRenderAttr("src", _imports_0)} alt=""><h3>${ssrInterpolate(_ctx.$t("YOU BOOKED YOUR APPOINTMENT SUCCESSFULLY"))}</h3><p>visit id: `);
      if (unref(id)) {
...
//# sourceMappingURL=booked-0a1e1261.mjs.map
