...
import { useSSRContext, ref, unref } from 'file://F:/github/AlKathiri-Frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate } from 'file://F:/github/AlKathiri-Frontend/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="modal-footer"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">${ssrInterpolate(_ctx.$t("close"))}</button><button type="button" class="btn btn-primary">${ssrInterpolate(_ctx.$t("Send message"))}</button></div></div></div></div></div>`);
    };
  }
};
...
//# sourceMappingURL=privacyModal-ded9970f.mjs.map
