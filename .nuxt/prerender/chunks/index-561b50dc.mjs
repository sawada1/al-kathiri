...
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderAttr, ssrInterpolate, ssrRenderClass, ssrIncludeBooleanAttr, ssrLooseEqual, ssrRenderList } from 'file://F:/github/AlKathiri-Frontend/node_modules/vue/server-renderer/index.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(typeActive) == 1) {
        ...
        if (unref(salaryError)) {
          _push(`<span class="errorMessage text-danger fw-bold">${ssrInterpolate(unref(salaryError))}</span>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (unref(commitmentsError)) {
          _push(`<span class="errorMessage text-danger fw-bold">${ssrInterpolate(unref(commitmentsError))}</span>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (unref(having_loanError)) {
          _push(`<span class="errorMessage text-danger fw-bold">${ssrInterpolate(unref(having_loanError))}</span>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (unref(last_installmentError)) {
          _push(`<span class="errorMessage text-danger fw-bold">${ssrInterpolate(unref(last_installmentError))}</span>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (unref(first_installmentError)) {
          _push(`<span class="errorMessage text-danger fw-bold">${ssrInterpolate(unref(first_installmentError))}</span>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (unref(workError)) {
          _push(`<span class="errorMessage text-danger fw-bold">${ssrInterpolate(unref(workError))}</span>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (unref(bankError)) {
          _push(`<span class="errorMessage text-danger fw-bold">${ssrInterpolate(unref(bankError))}</span>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (unref(drivingError)) {
          _push(`<span class="errorMessage text-danger fw-bold">${ssrInterpolate(unref(drivingError))}</span>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (unref(nameCashError)) {
          _push(`<span class="errorMessage text-danger fw-bold">${ssrInterpolate(unref(nameCashError))}</span>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (unref(phoneCashError)) {
          _push(`<span class="errorMessage text-danger fw-bold">${ssrInterpolate(unref(phoneCashError))}</span>`);
        } else {
          _push(`<!---->`);
        }
      ...
      if (unref(typeActive) == 2) {
        ...
        if (unref(organization_nameError)) {
          _push(`<span class="errorMessage text-danger fw-bold">${ssrInterpolate(unref(organization_nameError))}</span>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (unref(organization_emailError)) {
          _push(`<span class="errorMessage text-danger fw-bold">${ssrInterpolate(unref(organization_emailError))}</span>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (unref(organization_ceoError)) {
          _push(`<span class="errorMessage text-danger fw-bold">${ssrInterpolate(unref(organization_ceoError))}</span>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (unref(phoneCorporateError)) {
          _push(`<span class="errorMessage text-danger fw-bold">${ssrInterpolate(unref(phoneCorporateError))}</span>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (unref(organization_locationError)) {
          _push(`<span class="errorMessage text-danger fw-bold">${ssrInterpolate(unref(organization_locationError))}</span>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (unref(organization_activityError)) {
          _push(`<span class="errorMessage text-danger fw-bold">${ssrInterpolate(unref(organization_activityError))}</span>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (unref(organization_ageError)) {
          _push(`<span class="errorMessage text-danger fw-bold">${ssrInterpolate(unref(organization_ageError))}</span>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (unref(bankCorporateError)) {
          _push(`<span class="errorMessage text-danger fw-bold">${ssrInterpolate(unref(bankCorporateError))}</span>`);
        } else {
          _push(`<!---->`);
        }
        ...
        ssrRenderList(unref(form), (item, index) => {
          ...
          if (unref(car_nameErorr)) {
            _push(`<span class="errorMessage text-danger fw-bold">${ssrInterpolate(unref(car_nameErorr))}</span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<input type="number" placeholder="the number"${ssrRenderAttr("value", item.count)}>`);
          if (unref(car_countErorr)) {
            _push(`<span class="errorMessage text-danger fw-bold">${ssrInterpolate(unref(car_countErorr))}</span>`);
          } else {
            _push(`<!---->`);
          }
...
//# sourceMappingURL=index-561b50dc.mjs.map
