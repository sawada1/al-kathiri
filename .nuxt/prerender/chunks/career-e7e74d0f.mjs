...
import { ref, computed, unref, withCtx, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, useSSRContext } from 'file://F:/github/AlKathiri-Frontend/node_modules/vue/index.mjs';
import { g as getUrl } from './useState-8b8d35cc.mjs';
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderAttr, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderComponent, ssrIncludeBooleanAttr } from 'file://F:/github/AlKathiri-Frontend/node_modules/vue/server-renderer/index.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(allJobs), (job) => {
        ...
        if (unref(checkJob) == job.id) {
          _push(`<div><form action="">`);
          _push(ssrRenderComponent(_component_nuxt_link, { to: "/careers" }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<h5${_scopeId}><i class="fa-solid fa-chevron-left"${_scopeId}></i> ${ssrInterpolate(job.title)}</h5>`);
              } else {
                return [
                  createVNode("h5", null, [
                    createVNode("i", { class: "fa-solid fa-chevron-left" }),
                    createTextVNode(" " + toDisplayString(job.title), 1)
                  ])
                ];
              }
            }),
          ...
          _push(`<div class="inp"><label for="">${ssrInterpolate(_ctx.$t("full name"))}</label><input${ssrRenderAttr("value", unref(namee))} type="text"${ssrRenderAttr("placeholder", _ctx.$t("write your name.."))}>`);
          if (unref(nameError)) {
          ...
          if (unref(cvError)) {
            _push(`<span class="errorMessage text-danger fw-bold">${ssrInterpolate(unref(cvError))}</span>`);
          } else {
            _push(`<!---->`);
          }
...
//# sourceMappingURL=career-e7e74d0f.mjs.map
