...
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderAttr, ssrInterpolate, ssrRenderList } from 'file://F:/github/AlKathiri-Frontend/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(pending)) {
        _push(`<div class="offersCars" style="${ssrRenderStyle({ "margin-top": "150px" })}"><div class="container" style="${ssrRenderStyle({ "min-height": "100vh" })}"><div class="head"><h3${ssrRenderAttr("data-offers", _ctx.$t("GET our"))}>${ssrInterpolate(_ctx.$t("SPATIAL OFFERS"))}</h3></div><div class="row offers px-2 justify-content-around gap-2"><!--[-->`);
...
//# sourceMappingURL=index-aedf4e2b.mjs.map
