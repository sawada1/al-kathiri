import { getCurrentInstance, version, inject, defineComponent, h, onUnmounted, ref, watchEffect, watch, computed, Fragment as Fragment$1, isRef, useSSRContext, createApp, reactive, unref, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, isReadonly, Text, defineAsyncComponent, effectScope, withCtx, nextTick, Suspense, Transition } from 'file://F:/github/AlKathiri-Frontend/node_modules/vue/index.mjs';
import { $fetch } from 'file://F:/github/AlKathiri-Frontend/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file://F:/github/AlKathiri-Frontend/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://F:/github/AlKathiri-Frontend/node_modules/unctx/dist/index.mjs';
import { renderSSRHead } from 'file://F:/github/AlKathiri-Frontend/node_modules/@unhead/ssr/dist/index.mjs';
import { getActiveHead, createServerHead as createServerHead$1 } from 'file://F:/github/AlKathiri-Frontend/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://F:/github/AlKathiri-Frontend/node_modules/@unhead/shared/dist/index.mjs';
import { useRouter as useRouter$1, useRoute as useRoute$1, createMemoryHistory, createRouter, RouterView } from 'file://F:/github/AlKathiri-Frontend/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file://F:/github/AlKathiri-Frontend/node_modules/h3/dist/index.mjs';
import { hasProtocol, parseURL, joinURL } from 'file://F:/github/AlKathiri-Frontend/node_modules/ufo/dist/index.mjs';
import { CoreWarnCodes, CompileErrorCodes, registerMessageResolver, resolveValue, registerLocaleFallbacker, fallbackWithLocaleChain, setDevToolsHook, createCompileError, DEFAULT_LOCALE as DEFAULT_LOCALE$1, updateFallbackLocale, NUMBER_FORMAT_OPTIONS_KEYS, DATETIME_FORMAT_OPTIONS_KEYS, setFallbackContext, createCoreContext, clearDateTimeFormat, clearNumberFormat, setAdditionalMeta, getFallbackContext, NOT_REOSLVED, isTranslateFallbackWarn, isTranslateMissingWarn, parseTranslateArgs, translate, MISSING_RESOLVE_VALUE, parseDateTimeArgs, datetime, parseNumberArgs, number } from 'file://F:/github/AlKathiri-Frontend/node_modules/@intlify/core-base/dist/core-base.mjs';
import { setupDevtoolsPlugin } from 'file://F:/github/AlKathiri-Frontend/node_modules/vue-devtools-stub/dist/index.mjs';
import { VueDevToolsLabels, VueDevToolsPlaceholders, VueDevToolsTimelineColors } from 'file://F:/github/AlKathiri-Frontend/node_modules/@intlify/vue-devtools/dist/vue-devtools.mjs';
import { parse, serialize } from 'file://F:/github/AlKathiri-Frontend/node_modules/cookie-es/dist/index.mjs';
import isHTTPS from 'file://F:/github/AlKathiri-Frontend/node_modules/is-https/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://F:/github/AlKathiri-Frontend/node_modules/vue/server-renderer/index.mjs';
import { defu } from 'file://F:/github/AlKathiri-Frontend/node_modules/defu/dist/defu.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./about-1eb071d9.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./booked-0a1e1261.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./index-b76cb7dd.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./brands-7efa48a0.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./index-ff686385.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./career-e7e74d0f.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./index-ccfdc396.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./contact-9f6f2a63.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./faQ-5fa09a9c.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./fav-454d785f.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./index-0efc53f7.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./maintenance-41f14cf1.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./new-aa8571b8.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./index-c4ce58b7.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./notFound-6fcb6051.mjs').then((m) => m.default || m)
  },
  {
    name: "notFound___ar___default",
    path: "/notFound",
    meta: {},
    alias: [],
    redirect: void 0,
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./offer-5e9b5a59.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./index-aedf4e2b.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./index-561b50dc.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./submited-1b2ffe4b.mjs').then((m) => m.default || m)
  },
  {
...
{
  shared$1.exports = requireShared();
}
...
const nuxtI18nInternalOptions = Object({ __normalizedLocales: [Object({ "code": "en", "iso": "en", "dir": "ltr", "name": "english", "file": "en.json", "hash": "b9fcf575", "type": "static" }), Object({ "code": "ar", "iso": "ar", "dir": "rtl", "name": "عربي", "file": "ar.json", "hash": "4a1ec83a", "type": "static" })] });
...
const layouts = {
  default: () => import('./default-a4ec612e.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./error-component-e8a14dc2.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./island-renderer-b71ae467.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
