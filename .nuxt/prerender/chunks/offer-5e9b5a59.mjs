...
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderAttr, ssrInterpolate, ssrRenderComponent, ssrRenderList, ssrRenderClass } from 'file://F:/github/AlKathiri-Frontend/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(pending)) {
        _push(`<div class="theOffer" style="${ssrRenderStyle({ "margin-top": "150px" })}"><div class="container"><div class="containe px-3"><img${ssrRenderAttr("src", unref(theOffer).image)} class="w-100"${ssrRenderAttr("alt", unref(theOffer).title)}><h3 class="my-3 fw-bolder thehead">${ssrInterpolate(unref(theOffer).title)}</h3>`);
...
//# sourceMappingURL=offer-5e9b5a59.mjs.map
